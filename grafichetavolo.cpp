...
int main() {
  ...
  while (window.isOpen()) {
    ...
    drawRect(window, 660, 740, 120, 120, sf::Color(150, 150, 150), 2.f,
             sf::Color::White, 0);  // YOU
    ...
    drawRect(window, 725, 600, 63, 88, sf::Color::White, 0.f, sf::Color::White,
             0);  // card 2 you
    drawRect(window, 725, 100, 63, 88, sf::Color::White, 0.f, sf::Color::White,
             0);  // card 2 dealer
    drawRect(window, 645, 100, 63, 88, sf::Color::White, 0.f, sf::Color::White,
             0);  // card 1 dealer
    ...
    drawRect(window, 850, 810, 100, 50, sf::Color(150, 150, 150), 2,
             sf::Color::White, 0);  // double button
    drawRect(window, 980, 810, 100, 50, sf::Color(150, 150, 150), 2,
             sf::Color::White, 0);  // split button

    drawRect(window, 850, 740, 100, 50, sf::Color(150, 150, 150), 2,
             sf::Color::White, 0);  // hit button
    drawRect(window, 980, 740, 100, 50, sf::Color(150, 150, 150), 2,
             sf::Color::White, 0);  // stand button
    drawRect(window, 190, 540, 130, 130, sf::Color(150, 150, 150), 2,
             sf::Color::White, 45);  // P1 box
    drawRect(window, 1250, 530, 130, 130, sf::Color(150, 150, 150), 2,
             sf::Color::White, 45);  // P2 box
    ...
    window.draw(button);
    DrawText(window, font, "+10", 560, 785, 15, sf::Color::Black, 0);
